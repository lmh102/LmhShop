        ...
        <div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column hover-scroll-y pe-4 me-n4" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar, #kt_app_sidebar_nav" data-kt-scroll-offset="5px" style="height: 511px;">
            ...
            <div class="app-sidebar-nav mb-4" id="kt_app_sidebar_nav">
                ...
                <div class="links row row-cols-3" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]" data-kt-initialized="1">
                    ...
                    <div class="col mb-4">
                        <!--begin::Link-->
                        <a href="/LmhShop/admin/home" class="btn btn-custom btn-outline btn-icon btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-0" data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                    ...
                    <div class="col mb-4">
                        <!--begin::Link-->
                        <a href="/LmhShop/admin/listUser" class="btn btn-custom btn-outline btn-icon btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-0" data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                            ...
                            <!--end::Icon-->
                            <!--begin::Label-->
                            <span class="fs-7 fw-bold">List User</span>
                            <!--end::Label-->
                        </a>
                        <!--end::Link-->
                    </div>
    ...
    <div class="app-sidebar-footer d-flex flex-center px-4 py-4 py-lg-8" id="kt_app_sidebar_footer">
        ...
        <div class="user-toolbar d-flex align-items-center rounded px-5 py-3 mb-2">
            ...
            <div class="d-flex flex-column align-items-start flex-grow-1">
                <a href="" class="user-toolbar-title fs-6 fw-bold">${user.getFullName()}</a>
            </div>
            <!--end:Info-->
            <!--begin::User menu-->
            <div>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        ...
                        <div class="menu-item px-5">
                            <a href="/LmhShop/admin/listUser" class="menu-link px-5">List User</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
