                                        ...
                                        <div class="card-body pt-9 pb-0">
                                            ...
                                            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                                ...
                                                <div class="me-7 mb-4">
                                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                        <img src="${customer.getAvatar() == null ? "/LmhShop/assets/avatar/default-avatar.png" : customer.getAvatar()}" alt="image">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="d-flex align-items-center mb-2">
                                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">${customer.getFullName()}</a>
                                                                <a href="#">
                                                            ...
                                                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                <c:if test="${customer.getAddress()!= null}">
                                            ...
                                            <div class="card-body p-9">
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8">
                                                        <span class="fw-bold fs-6 text-gray-800">${customer.getFullName()}</span>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Row-->
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <span class="fw-semibold text-gray-800 fs-6">${customer.getEmail()}</span>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="col-lg-8 d-flex align-items-center">
                                                        <span class="fw-bold fs-6 text-gray-800 me-2">${customer.getPhone()}</span>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8">
                                                        <a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">${customer.getAddress()}</a>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8">
                                                        <span class="fw-bold fs-6 text-gray-800">${customer.getDob()}</span>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-10">
                                                    ...
                                                    <!--begin::Label-->
                                                    <div class="col-lg-8">
                                                        <span class="fw-semibold fs-6 text-gray-800">${customer.getCreateAt()}</span>
                                                    </div>
                                                    <!--begin::Label-->
                                                </div>
                                                <!--end::Input group-->
