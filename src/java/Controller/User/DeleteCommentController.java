...
public class DeleteCommentController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            request.setAttribute("redirectURL", "/LmhShop/home");
            request.getRequestDispatcher("/Views/NotFound.jsp");
        }
        CommentDAL _servirce = new CommentDAL();
        _servirce.delete(commentId);
        response.sendRedirect("/LmhShop/product?id="+request.getParameter("productId"));
    } 
